...
import useSingleCartHooks from "../../../hooks/CartHooks/useSingleCartHooks";
...
const CartCard = ({ item }) => {
  ...
  } = useSingleCartHooks(item);
  if (isdeleteCartItemLoading || isupdateCartItemLoading) return <Loader />;
