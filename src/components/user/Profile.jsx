...
import { User, Mail, Phone, MapPin, Calendar, Lock, Edit2, Save, X, Camera, Eye, EyeOff } from "lucide-react";
      ...
      <div className="max-w-4xl mx-auto">
        ...
        {successMessage && (
          <div className="mb-6 bg-green-50 border border-green-200 text-green-800 px-4 py-3 rounded-lg flex items-center">
            <div className="w-5 h-5 rounded-full bg-green-500 text-white flex items-center justify-center text-sm font-bold mr-3">✓</div>
            {successMessage}
          </div>
        )}
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden mb-6">
          ...
          <div className="px-8 pb-8">
            ...
            <div className="flex flex-wrap gap-3 justify-center sm:justify-start">
              ...
              >
                {editProfile ? <X className="w-4 h-4 mr-2" /> : <Edit2 className="w-4 h-4 mr-2" />}
              ...
              >
                {editPassword ? <X className="w-4 h-4 mr-2" /> : <Lock className="w-4 h-4 mr-2" />}
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center p-3 bg-gray-50 rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="font-medium text-gray-900">{formatDate(user?.DOB)}</p>
                  </div>
                </div>
                <div className="flex items-center p-3 bg-gray-50 rounded-lg">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    className="w-full p-3 border border-gray-300  text-black rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
